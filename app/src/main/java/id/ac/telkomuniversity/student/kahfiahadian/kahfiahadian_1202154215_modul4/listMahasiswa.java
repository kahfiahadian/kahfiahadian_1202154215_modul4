...
public class listMahasiswa extends AppCompatActivity {
    ...
    //mendeklarasikan method tombol
    public void mintalist(View view) {
    ...
    class getData extends AsyncTask<String, Integer, String> {
        ...
        public getData(ListView listMhs) {
            ...
            dialog = new ProgressDialog(listMahasiswa.this);
        ...
        protected String doInBackground(String... strings) {
            adapter = new ArrayAdapter<>(listMahasiswa.this, android.R.layout.simple_list_item_1, listNama); //membuat adapter
